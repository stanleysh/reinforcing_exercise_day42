let project = { 
  ...
  project.steps.forEach((e) => {
    let tempPerson = Math.floor(Math.random()*3);
    e.person = project.committee[tempPerson];
  });

//   Checking that person has been added to each project correctly
  console.log(project)